...
### 5. Forms. Редактор списка* (задача со звёздочкой)

[![Build](https://ci.appveyor.com/api/projects/status/mvw12lbjftg1isdr?svg=true)](https://ci.appveyor.com/project/npeplov/ahj-forms-goodslist)

Environment: https://npeplov.github.io/ahj-forms-goodslist
